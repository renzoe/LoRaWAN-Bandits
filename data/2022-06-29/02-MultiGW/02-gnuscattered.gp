...
set ylabel 'X [mts]'
plot './01-LegacyADR/nodeData.txt' using  3:($1==118800?$4:1/0):5 with point pt 14 palette z   # 100 SAMPLES


unset ylabel
#unset xtics
#unset ytics
plot './02-BanditPDR/nodeData.txt' using  3:($1==118800?$4:1/0):5 with point pt 14 palette z   # 100 SAMPLES

plot './03-BanditEnergyPDR/nodeData.txt' using  3:($1==118800?$4:1/0):5 with point pt 14 palette z   # 100 SAMPLES
