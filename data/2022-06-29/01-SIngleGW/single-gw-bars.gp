...
plot '03-phyPerformance.dat' using 4 t "Received", '' using 5 t "Interfered"  ,  '' using 7 t "Under Sensitivity" , '' using 8 t "Lost Because TX"
unset label
...
plot '02-phyPerformance.dat' using 4 t "Received", '' using 5 t "Interfered"  , '' using 7 t "Under Sensitivity" , '' using 8 t "Lost Because TX"
unset label
...
plot '01-phyPerformance.dat' using 4 t "Received", '' using 5 t "Interfered"  ,  '' using 7 t "Under Sensitivity" , '' using 8 t "Lost Because TX"
unset label
