...
MacCommand::GetCIDFromMacCommand (enum MacCommandType commandType)
{
  ...
  switch (commandType)
    ...
    case (BANDIT_REWARD_REQ): // A Propietary network command (Renzo, I choose 0xBB). See "LoRaWAN L2 1.0.4 Specification (TS001-1.0.4)" page 27/90
...
/**************************************
 *  Bandits new propietary MAC commands
 ************************************** */
///////////////////////
// BANDIT_REWARD_REQ //
///////////////////////
//BanditRewardReq
BanditRewardReq::BanditRewardReq ()
{
  NS_LOG_FUNCTION (this);
  ...
  m_fCnt_to (fCnt_to)
{
  ...
  m_commandType = BANDIT_REWARD_REQ;
  m_serializedSize = 4; // Includes 1 byte of the m_commandType
}

void
BanditRewardReq::Serialize (Buffer::Iterator &start) const
{
  NS_LOG_FUNCTION_NOARGS ();
...
uint8_t
BanditRewardReq::Deserialize (Buffer::Iterator &start)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
BanditRewardReq::Print (std::ostream &os) const
{
  NS_LOG_FUNCTION_NOARGS ();
...
BanditRewardAns::BanditRewardAns ()
{
  NS_LOG_FUNCTION (this);
...
void
BanditRewardAns::Serialize (Buffer::Iterator &start) const
{
  NS_LOG_FUNCTION_NOARGS ();
...
uint8_t
BanditRewardAns::Deserialize (Buffer::Iterator &start)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
BanditRewardAns::Print (std::ostream &os) const
{
  NS_LOG_FUNCTION_NOARGS ();
