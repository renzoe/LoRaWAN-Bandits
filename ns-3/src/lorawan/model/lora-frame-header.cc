      ...
      if (m_isUplink)
        {
          switch (cid)
            ...
            case (0xBB): /* [Renzo] Related to new custom MAC command for Bandits, uplink will be a BANDIT_REWARD_REQ */
              {
      ...
      else
        {
          switch (cid)
            ...
            case (0xBB): /* [Renzo] Related to new custom MAC command for Bandits, uplink will be a BANDIT_REWARD_ANS */
              {
